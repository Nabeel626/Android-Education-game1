...
public class Advanced_Level extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flag_one = findViewById(R.id.flag_one);
        flag_two = findViewById(R.id.flag_two);
        flag_three = findViewById(R.id.flag_three);
        ...
        int[] flag1 = {different1,different2,different3};
        ...
        Submit.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                if (r1 == different1) {
                    text1.setTextColor(Color.GREEN); //This will change the colour of the text
                } else {
                    text1.setTextColor(Color.RED); //This will change the colour of the text
                }
                if (r1 == different2) {
                    text2.setTextColor(Color.GREEN); //This will change the colour of the text
                } else {
                    text2.setTextColor(Color.RED); //This will change the colour of the text
                }
                if (r1 == different3){
                    text3.setTextColor(Color.GREEN); //This will change the colour of the text
                } else {
                    text3.setTextColor(Color.RED); //This will change the colour of the text
                }

                if(r1 == different1 && r1 == different2 && r1 == different3){
                    Button Next = findViewById(R.id.submit1);
                    Next.setText("Next");
